...
contract DecentPrimalLotteryUser is Ownable {
     ...
     */
    mapping (string => address) public userNameToAddress;  // This is the seraching map that given a userName, returns its address.
    ...
    function checkuserName(string memory _username) public view returns(address) {
